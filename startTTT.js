...
var ts = 0;
function help() {
alert("Welcome to Z's Tic Tac! My Name is Zuwa.  You play as the U's and I play as the Z's.  Select the square you want to put your U into by clicking them.  You cannot occupy a square that is already occupied. The first player to get three squares in a row wins.  BRING IT ON!!")
}
function logicOne() {
...
function taken() {
alert("Smart one, that square is already occupied.  Please select another square.")
pause=1;
}
function myChoice() {
temp="";
...
function process() {
logicOne();
if (all==1){ alert("Congrats! But I won't let it happen again!"); wn++; }
if (all==2){ alert("Gotcha!  I win!"); ls++; }
if (all==3){ alert("We tied, I feel belittled"); ts++; }
if (all!=0) {
...
function quitter()
{
	if(confirm("I'm glad you know you are a looser! Confirm or CANCEL")) 
	{
		document.location="http://www.cuchapter.com";
	}
}
//  End -->
